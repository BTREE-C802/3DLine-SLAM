...
namespace L3DPP
{
	...
	//更新类的成员变量，涉及到位姿和深度值
	void UpdateView(const unsigned int id, 
	...
	int getLineNum();
        ...
        Eigen::Matrix<double,3,4> KRt() const {return KRt_;}//反投影矩阵
    ...
    private:
        ...
        Eigen::Vector3d C_;
        Eigen::Vector3d pp_;
	Eigen::Matrix<double,3,4> KRt_;//反投影矩阵
        unsigned int width_;
        ...
        // regularizer
        float k_;
        float initial_median_depth_ = 0.0f;
        float median_depth_;
        float median_sigma_;
